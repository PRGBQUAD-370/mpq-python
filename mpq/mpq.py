...
resp = user32.MessageBoxW(
    0,
    "FINAL WARNING:\n\nThe creator PRGBQUAD-370 from github is not resonsible for any display corruptions\n\nThis is the last time you can press cancel before this Runs GDI effects",
    "Final Warning",
    MB_OKCANCEL | MB_ICONWARNING
)
